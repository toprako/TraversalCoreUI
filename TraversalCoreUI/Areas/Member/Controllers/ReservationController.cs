...
namespace TraversalCoreUI.Areas.Member.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        ReservationManager reservationManager = new(new EfResevationDal());
        ...
        {
            model.AppUserId = Guid.Parse("2c624859-0c5f-435d-ee14-08db596ee2f2");
